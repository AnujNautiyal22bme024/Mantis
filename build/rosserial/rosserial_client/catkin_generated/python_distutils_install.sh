...
echo_and_run cd "/home/psychedelic/mantis/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/psychedelic/mantis/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/psychedelic/mantis/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
