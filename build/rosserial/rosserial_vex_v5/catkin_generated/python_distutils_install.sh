...
echo_and_run cd "/home/psychedelic/mantis/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/psychedelic/mantis/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/psychedelic/mantis/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
